...
export function GestionClient({ initialSettings }: { initialSettings: SalonSettings | null }) {
  ...
  const [settings, setSettings] = useState<SalonSettings | null>(initialSettings);
                        ...
                        [
                          ...
                          },
                          {
                            ...
                            items: [
                              ...
                              { key: "herofeature", label: "Point fort", desc: "Texte et lueur des points forts en bas de la carte", value: appearanceHeroFeature, setter: setAppearanceHeroFeature },
                            ],
                          },
                          {
                            title: "Prestations",
