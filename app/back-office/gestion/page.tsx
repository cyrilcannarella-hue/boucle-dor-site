...
const fieldClass = "rounded-2xl border border-[#eadfce] bg-white px-4 py-3 text-[#1f1b17] outline-none transition focus:border-[#b98b3d]";
      ...
      <header className="md:sticky top-0 z-30 border-b border-[#eadfce]/80 bg-[#fffaf4]/90 shadow-[0_10px_30px_rgba(80,55,25,0.06)] backdrop-blur-xl">
        <div className="mx-auto flex w-[min(1400px,calc(100%-24px))] items-center justify-between gap-3 py-3 md:py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-[#b98b3d] md:text-[11px]">
                Back office
              </div>
        ...
        <div className="mb-7 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-3 text-base leading-7 text-[#6f6254]">
              ...
              {activeTab === "services" && "Créez et modifiez les prestations proposées."}
            </p>
          </div>
        </div>
          ...
          {loading ? (
            <div className="rounded-[26px] border border-dashed border-[#dccdbb] bg-white/70 px-6 py-14 text-center text-[#6f6254] shadow-sm">
              Chargement de la gestion du salon...
            </div>
          ) : (
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:gap-6">
              <nav className="flex flex-row flex-wrap gap-1.5 md:sticky md:top-[76px] md:w-44 md:shrink-0 md:flex-col">
                {([
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2.5 rounded-2xl px-4 py-3 text-sm font-semibold text-left transition ${
                      activeTab === tab.id
                        ? "bg-[#1f1b17] text-white shadow-[0_8px_20px_rgba(31,27,23,0.2)]"
                        : "border border-[#eadfce] bg-white/80 text-[#4d453d] hover:-translate-y-0.5 hover:bg-white"
                    }`}
                  >
                          ...
                          >
                            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                              <div>
                                ...
                                {closure.reason ? (
                                  <div className="mt-1 text-sm text-[#6f6254]">Motif : {closure.reason}</div>
                                ) : null}
                              </div>
                      ...
                      {[
                        ...
                        <label
                          ...
                          className={`flex items-center justify-between rounded-2xl border px-4 py-3 text-sm font-semibold transition ${
                            settings[key as keyof SalonSettings]
                              ? "border-[#E8C9AD] bg-[#FFF6EE] text-[#b98b3d]"
                              : "border-[#eadfce] bg-[#fffdf9] text-[#6f6254]"
                          }`}
                        >
                          <span>{label}</span>
                          <input
                            type="checkbox"
                            checked={Boolean(settings[key as keyof SalonSettings])}
                            onChange={(e) =>
                              setSettings({
                                ...settings,
              ...
              <div className={cardClass + " p-5 md:p-7"}>
                      ...
                      categories.map((category) => (
                        <div key={category.id} className="rounded-2xl border border-[#eadfce] bg-[#fffdf9] p-4">
                          <input
                            ...
                            className="w-full rounded-2xl border border-[#eadfce] bg-white px-4 py-3 font-semibold outline-none transition focus:border-[#b98b3d]"
                          />
                  ...
                  <div className="mt-6 rounded-3xl border border-[#eadfce] bg-[#fffdf9] p-5">
                    ...
                    <button
                      ...
                      className="mt-5 w-full rounded-2xl bg-[#1f1b17] px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:opacity-90 disabled:opacity-50"
                    >
              ...
              <div className={cardClass + " p-5 md:p-7"}>
                  <div className="mb-6">
                    ...
                    <h2 className="text-2xl font-semibold tracking-tight">Coiffeuses</h2>
                    <p className="mt-1 text-sm text-[#6f6254]">Horaires et pauses par jour, dans les limites du salon.</p>
                  </div>

                  <div className="space-y-6">
                    {staff.length === 0 ? (
                      <div className="rounded-[24px] border border-dashed border-[#dccdbb] bg-white/70 px-4 py-8 text-center text-sm text-[#6f6254]">
                      ...
                      return (
                        <div key={member.id} className={panelClass + " p-4"}>
                                      ...
                                      <>
                                        ...
                                        <div className="flex items-center gap-1.5">
                                          <input type="time"
                                            ...
                                            className="rounded-xl border border-[#eadfce] bg-[#faf8f5] px-2 py-1 text-xs text-[#1f1b17] outline-none focus:border-[#b98b3d]" />
                                        ...
                                        {sched.has_break && (
                                          <div className="flex items-center gap-1.5">
                                            ...
                                            <input type="time"
                                              ...
                                              className="rounded-xl border border-[#eadfce] bg-[#fff8ee] px-2 py-1 text-xs text-[#1f1b17] outline-none focus:border-[#b98b3d]" />
                          ...
                          {updatingStaffId === member.id ? <div className="mt-2 text-xs text-[#6f6254]">Enregistrement...</div> : null}
                        </div>
                      );
                    })}
                  </div>
              ...
              <div className={cardClass + " p-5 md:p-7"}>
                  ...
                  <div className="mb-4">
                    <select
                      ...
                      className="w-full rounded-2xl border border-[#eadfce] bg-white px-4 py-3 text-sm font-semibold text-[#1f1b17] outline-none focus:border-[#b98b3d]"
                    >
                  ...
                  <div className="grid gap-4">
                    {services.filter((s) => selectedCategory === "all" || s.category_id === selectedCategory).length === 0 ? (
                      ...
                      services.filter((s) => selectedCategory === "all" || s.category_id === selectedCategory).map((service) => {
                        ...
                        const total = getTotalDuration(before, pause, after);
                        const categoryColor =
                          categories.find((category) => category.id === service.category_id)?.color ?? "#EADCCB";

                        return (
                          <div
                            key={service.id}
                            className="rounded-2xl border bg-[#fffdf9] p-4 shadow-sm"
                          ...
                          >
                            ...
                            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-8">
                              ...
                              <label className="grid gap-2 text-sm font-semibold text-[#6f6254]">
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    ...
                                    if (value !== before) {
                                      handleUpdateService(service.id, { duration_before_break: value });
                                    }
                                  }}
                                  className={fieldClass}
                                />
                              ...
                              <label className="grid gap-2 text-sm font-semibold text-[#6f6254]">
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    const value = Math.max(0, Number(e.target.value) || 0);
                                    if (value !== pause) {
                                      handleUpdateService(service.id, { break_duration: value });
                                    }
                                  }}
                                  className={fieldClass}
                                />
                              ...
                              <label className="grid gap-2 text-sm font-semibold text-[#6f6254]">
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    const value = Math.max(0, Number(e.target.value) || 0);
                                    if (value !== after) {
                                      handleUpdateService(service.id, { duration_after_break: value });
                                    }
                                  }}
                                  className={fieldClass}
                                />
                              ...
                              <label className="grid gap-2 text-sm font-semibold text-[#6f6254]">
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    const value = normalizePriceToCents(e.target.value);
                                    if (value !== service.price_cents) {
                                      handleUpdateService(service.id, { price_cents: value });
                                    }
                                  }}
                                  className={fieldClass}
                                />
                              ...
                              <label className="grid gap-2 text-sm font-semibold text-[#6f6254]">
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    ...
                                    if (value !== service.display_order) {
                                      handleUpdateService(service.id, { display_order: value });
                                    }
                                  }}
                                  className={fieldClass}
                                />
                            ...
                            <div className="mt-4 flex justify-end gap-2">
                              {confirmDeleteServiceId === service.id ? (
                                <>
                                  <button
                                    type="button"
                                    onClick={() => { handleDeleteService(service.id); setConfirmDeleteServiceId(null); }}
                            ...
                            {updatingServiceId === service.id ? (
                              <div className="mt-3 text-sm text-[#6f6254]">Enregistrement...</div>
                            ) : null}
                          </div>
                        );
                      })
