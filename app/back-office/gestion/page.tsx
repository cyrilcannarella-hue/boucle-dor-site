                        ...
                        <label
                          ...
                          className={`flex items-center justify-between rounded-2xl border px-4 py-3 text-sm font-semibold transition ${
                            settings[key as keyof SalonSettings]
                              ? "border-[#E8C9AD] bg-[#FFF6EE] text-[var(--gold)]"
              ...
              {activeTab === "prestations" && <section className={cardClass + " p-5 md:p-7"}>
                  ...
                  <div className="mb-4">
                    <select
                      ...
                      className="w-full rounded-2xl border border-[#eadfce] bg-white px-4 py-3 text-sm font-semibold text-[#1f1b17] outline-none focus:border-[var(--gold)]"
                    >
